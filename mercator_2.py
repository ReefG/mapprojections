...
def transform(phi_pixel, theta):
    x = round(map_width*theta/2048)
    phi_angle = math.pi*phi_pixel/1024 - 0.4999999*math.pi #from -0.5pi to 0.5pi
    y = round( math.log(math.tan(phi_angle) + 1/math.cos(phi_angle)) )
    # print(y)
    y_pixel = round((y + 16)/22*1999)
    return (x,y_pixel)
